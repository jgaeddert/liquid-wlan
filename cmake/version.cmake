function(get_version HEADER_FILE OUTPUT_VAR)
    ...
    string(REGEX MATCH "#define[ \t]+LIQUID_WLAN_VERSION_MAJOR[ \t]+([0-9]+)" _ ${HEADER_CONTENTS})
    set(VERSION_MAJOR ${CMAKE_MATCH_1})

    string(REGEX MATCH "#define[ \t]+LIQUID_WLAN_VERSION_MINOR[ \t]+([0-9]+)" _ ${HEADER_CONTENTS})
    set(VERSION_MINOR ${CMAKE_MATCH_1})

    string(REGEX MATCH "#define[ \t]+LIQUID_WLAN_VERSION_PATCH[ \t]+([0-9]+)" _ ${HEADER_CONTENTS})
